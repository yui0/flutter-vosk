...
public class FFmpegKitFlutterPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, EventChannel.StreamHandler, PluginRegistry.ActivityResultListener {
    ...
    public static void registerWith(FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
        ...
        FFmpegKitFlutterPlugin plugin = new FFmpegKitFlutterPlugin();
        plugin.init(flutterPluginBinding.getBinaryMessenger(), context, null, flutterPluginBinding, null);
    }
    ...
    @SuppressWarnings("deprecation")
    protected void init(final BinaryMessenger messenger, final Context context, final Activity activity, final FlutterPlugin.FlutterPluginBinding/*io.flutter.plugin.common.PluginRegistry.Registrar*/ registrar, final ActivityPluginBinding activityBinding) {
